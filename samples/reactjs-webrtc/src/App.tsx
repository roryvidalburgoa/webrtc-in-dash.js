    ...
    const handleShowModal = () => {
        ...
        setTimeout(() => {
            if (modalContainerRef.current) {
                init('GPS123456', 'Equipment-001', modalContainerRef.current);
            }
        }, 100);
    };
        ...
        <div className="container" style={{ marginTop: '50px' }}>
            <div className="row">
                <div className="col-md-12">
                    <h1 className="text-center">Dashcam Live Feed Modal Demo</h1>
                    <hr />
                </div>
            </div>
                ...
                <div className="col-md-12">
                    <div className="panel panel-default">
                        ...
                        <div className="panel-body">
                            <p>This demo shows how to use the DashcamLiveFeedModal component with both MPEG-DASH and WebRTC streaming.</p>
                            
                            <div className="well" style={{ backgroundColor: '#f5f5f5', padding: '15px', marginBottom: '20px' }}>
                                <h4>Streaming Mode Selection</h4>
                                <div className="form-group">
                                    <label className="checkbox-inline" style={{ fontSize: '16px', fontWeight: 'bold' }}>
                                        <input 
                                            type="checkbox" 
                                            checked={useWebRTC}
                                    ...
                                    <div style={{ marginTop: '10px', marginLeft: '25px' }}>
                                        ...
                                        <span className={`label ${useWebRTC ? 'label-success' : 'label-primary'}`} style={{ fontSize: '14px' }}>
                                ...
                                {useWebRTC ? (
                                    <div className="alert alert-success" style={{ marginTop: '15px' }}>
                                        <strong>WebRTC Mode:</strong> Will connect to camera.geometris.com using WebRTC with Socket.IO
                                    ...
                                    <div className="alert alert-info" style={{ marginTop: '15px' }}>
                                        <strong>DASH Mode:</strong> Will use sample MPEG-DASH streams from Akamai test servers
                                    </div>
                                )}
                            </div>
                            ...
                            <ul>
                                <li>Check browser compatibility (Mac/iPhone devices are not supported)</li>
                                <li>{useWebRTC ? 'Connect to WebRTC server via Socket.IO' : 'Load live camera feeds using MPEG-DASH streaming'}</li>
                                <li>Allow switching between front and rear cameras</li>
                                <li>{useWebRTC ? 'Handle WebRTC connection and ICE negotiation' : 'Handle stream URL expiration and renewal'}</li>
                            </ul>
                            ...
                            <button 
                                ...
                                disabled={showModal}
                            >
                                {showModal ? 'Modal is Active' : 'Open Dashcam Live Feed Modal'}
                            </button>
                        ...
                        <div className="panel-body text-center">
                            ...
                            <p>
                                <a 
                                    ...
                                    style={{ fontSize: '16px' }}
                                >
                                    <i className="glyphicon glyphicon-link"></i> View on GitHub
                                </a>
                            </p>
